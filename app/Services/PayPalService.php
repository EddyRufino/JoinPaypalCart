...
class PayPalService
{
    ...
    {
        $order = $this->createOrder($request->shopping_cart->amount());
    ...
    public function handleApproval()
    {
        if (session()->has('approvalId')) {
            ...
            $order = Order::createFromPayPalResponse($payment, $shopping_cart_id);
            // dump($order);
            // dump($id);
            ...
            // dump($payment);
            // dump($name = $payment->payer->name->given_name);
